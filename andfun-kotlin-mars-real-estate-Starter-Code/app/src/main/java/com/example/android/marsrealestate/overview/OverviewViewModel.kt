...
class OverviewViewModel : ViewModel() {
    ...
    val proerties: LiveData<List<MarsProperty>>
        get() = _properties
     ...
     */
    init {
        // To show all the property by default when the app first loads
    ...
    // To clear the live data to avoid it being triggered again
